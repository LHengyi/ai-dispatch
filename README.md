...
| Model | Cost | Notes |
|-------|------|-------|
| `gpt-5.6` | See official OpenAI pricing | Default OpenAI provider model |
| `gpt-5.6-luna` | See official pricing | Lower-cost option |
...
| 模型 | 费用 | 说明 |
|------|------|------|
| `gpt-5.6` | 参考 OpenAI 官方定价 | OpenAI provider 默认模型 |
| `gpt-5.6-luna` | 参考 OpenAI 官方定价 | 更省钱的选项 |
